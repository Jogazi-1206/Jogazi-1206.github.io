window.DB = {
    ...
    projects: [
        ...
        // 7. 시니어 인재 매칭 (Strategy)
        {
            ...
            summary: '대기업 은퇴 예정 인력을 스타트업 고문(Advisor)으로 매칭하는 AI 플랫폼 기획.',
            ...
            // 결과: '은퇴자'가 아니라 '현직 전문가'의 가치를 연결한다는 점 강조
            keyResult: '🤝 대기업 예비 은퇴 인력의 노하우를 스타트업에 "고문" 형태로 이식하는 상생 모델',
            
            catchphrase: '"은퇴는 끝이 아니라 새로운 시작: AI 기반 고문 매칭"',
            
            description_new: "대기업에서 은퇴를 앞둔 시니어 인재들의 전문성이 사장되지 않도록, 경험이 필요한 초기 스타트업에 '경영 고문' 형태로 파견하는 매칭 플랫폼을 기획했습니다.",
            
            problemSolving: [
                {
                    title: '문제 정의', // Mismatch
                    keyword: 'Talent Waste',
                    desc: '대기업 시니어의 "퇴직 전 커리어 전환 니즈"와 스타트업의 "C-Level 경험 부족"이라는 상반된 페인포인트를 연결하여 사회적 자원 낭비 해결.'
                },
                {
                    title: '솔루션', // Advisor Model
                    keyword: 'AI Matching',
                    desc: '단순 채용이 아닌 "고문 파견" 형식을 도입하여 비용 부담을 낮추고, AI가 가상 비즈니스 케이스 수행 능력을 평가하여 최적의 매칭 성사.'
                },
                {
                    title: '기술 전략', // Tech Feasibility
                    keyword: 'Synthetic Data',
                    desc: '매칭 정확도를 높이기 위한 초기 시니어 데이터가 부족한 점을 해결하기 위해, "합성 데이터"를 생성하여 AI를 학습시키는 기술적 방안 제시.'
                }
            ],
            
            images: [
                './images/fastcampus_1.jpg', // 구조도 (은퇴 예정자 -> 고문 -> 스타트업)
                './images/fastcampus_2.jpg', // 평가 프로세스
                './images/fastcampus_3.jpg'  // 합성 데이터 활용 도식
            ]
        },
        // 8. BACS 학회 (School)
        {
