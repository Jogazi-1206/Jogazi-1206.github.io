 ...
 * 포트폴리오 데이터 (Content)
 * [업데이트] 카테고리 2개로 통폐합
 * 1. data-tech: 데이터 분석, 엔지니어링, AI 모델링
 * 2. strategy-planning: 전략 기획, UX 설계, 아이디어 제안
 */

window.DB = {
    experience: [
        // ... (Experience는 기존과 동일하게 유지) ...
        {
            id: 'crevisse',
            ...
            problemSolving: [
                { title: 'Data Ops', keyword: 'Snowflake & Streamlit', desc: '기존 구글 시트 기반의 매출 데이터를 Snowflake로 이관하여 대용량 처리 기반을 마련. Python Streamlit으로 실시간 매출 대시보드를 직접 개발하여, 데이터 집계 시간을 단축하고 휴먼 에러를 0%로 제거.' },
                { title: 'SaaS Strategy', keyword: 'Salesforce & Market Research', desc: 'Salesforce 도입을 위한 PoC를 수행하여 젠데스크 데이터 마이그레이션 전략을 수립. 또한, 레거시 제품 고객의 전환 유도를 위해 글로벌 SaaS 선도 기업들의 GTM 전략을 벤치마킹하여 제안.' },
                { title: 'Key Projects', keyword: 'See Project Section', desc: '회사의 신규 수익원이 된 [데이터 품질 관리(DQM) 솔루션]과 업무 시간을 90% 단축한 [KISA 스팸 신고 자동화] 프로젝트를 리딩했습니다. (상세 내용은 Project 섹션 참조)' }
            ],
            images: [] 
        },
        {
            ...
            problemSolving: [
                { title: '데이터 구축', keyword: 'Data Integrity', desc: '150개 상장사의 S/G 지표 13,500건을 전수 조사하고, DART 공시와 교차 검증하여 결함 없는 대규모 ESG 데이터베이스 구축.' },
                { title: '업무 혁신', keyword: 'Python & Codebook', desc: '반복되는 인증서 수집 업무를 Python 크롤러로 자동화 설계하고, 지표별 빈출 키워드를 분석해 코드북(가이드라인)을 개선하여 팀 전체 효율성 증대.' },
                { title: '전략 리서치', keyword: 'Insight & Project', desc: '역량을 인정받아 수출입은행 GP 선정 기준 수립, 4대 핵심 산업(배터리/조선 등) 벤치마킹 등 고난도 리서치 과제에 추가 투입되어 전략적 인사이트 제공.' }
            ],
            images: []
        }
    ],
    ...
    projects: [
        // --- [Data & Tech] ---
        {
            ...
            problemSolving: [
                { title: '기획', keyword: 'Biz Model', desc: '국내외 선도 기업 리서치를 통해 6가지 핵심 진단 필드를 정의하고, [진단 → 자동 정제 → 외부 데이터 매칭]으로 이어지는 3단계 품질 관리 아키텍처 설계.' },
                { title: '개발', keyword: 'Python & TDD', desc: 'AI(Vibe Coding)를 활용해 개발하되, 비전공자의 한계를 극복하고자 100개 이상의 테스트 케이스(TDD)를 작성하여 코드의 무결성 검증. V1(개별 스크립트)에서 V2(통합 모듈)로 고도화.' },
                { title: '성과', keyword: 'Report Automation', desc: '20페이지 분량의 품질 진단 보고서 생성을 코드로 자동화하여 작업 시간을 획기적으로 단축. 성공적인 PoC를 통해 고객사 계약 체결 및 실제 매출 확보.' }
            ],
        ...
        },
        {
            ...
            problemSolving: [
                { title: '설계', keyword: 'Pain Point', desc: '메일 수신부터 고객사 안내까지 4단계의 수동 프로세스를 분석하여, 사람의 개입 없이 데이터가 흐를 수 있는 완전 자동화 파이프라인 설계.' },
                { title: '개발', keyword: 'GAS & Parsing', desc: 'Google Apps Script로 KISA 신고 메일을 파싱하여 DB에 적재하고, 매주 월요일 고객사별 내역을 API로 자동 발송하는 로직 구현.' },
                { title: '구현', keyword: 'Web App UI', desc: '고객사가 메일 회신 대신 직접 접속하여 소명 내용을 입력할 수 있는 [고객 전용 Web App]을 개발. 입력 데이터가 즉시 DB에 동기화되도록 하여 커뮤니케이션 비용 제로화.' }
            ],
        ...
        },
        {
            ...
            problemSolving: [
                { title: '가설 수립', keyword: 'Quant Indicators', desc: '이동평균선, RSI, MACD, 볼린저밴드 등 다양한 기술적 지표를 선정하고, "특정 지표들의 시그널이 겹칠 때 주가가 급등한다"는 퀀트 가설 수립.' },
                { title: '분석', keyword: 'Feature Importance', desc: '과거 급등 구간의 데이터를 역추적하여, 실제 주가 상승에 가장 큰 영향을 미친 "핵심 지표"가 무엇인지 통계적으로 규명.' },
                { title: '모델링', keyword: 'Binary Learning', desc: '도출된 핵심 지표를 기반으로 상승(1)과 하락/보합(0)을 예측하는 머신러닝 분류 모델을 학습시키고, 지속적인 파라미터 튜닝으로 예측 정확도 고도화.' }
            ],
        ...
        },
        {
            ...
            problemSolving: [
                { title: '문제 정의', keyword: 'Filtering Failure', desc: '기존 배달 앱의 최신순/별점순 정렬은 영양가 없는 짧은 글이나 스팸성 리뷰를 상단에 노출시켜, 사용자의 정보 탐색 비용을 높이는 문제 발견.' },
                { title: '리서치', keyword: 'Strategic Pivot', desc: '초기 단순 텍스트 분류 시도 실패 후, 문헌 조사를 통해 리뷰의 가치를 판단하는 핵심 지표가 "유용성"임을 도출하고 예측 모델로 방향 전환.' },
                { title: '모델링', keyword: 'Hybrid CNN', desc: '텍스트 임베딩을 CNN에 학습시키는 동시에, "가독성, 주관성, 감성 점수"라는 3가지 정량적 파생 변수를 결합하여 모델의 예측력을 극대화.' },
                { title: '검증', keyword: 'Quantitative Result', desc: '동일 데이터셋 기준 머신러닝대비 정확도(+0.15)와 정밀도(+0.14)가 대폭 향상된 0.76을 기록하며 딥러닝 도입의 타당성 입증.' }
            ],
        ...
        },
        {
            ...
            problemSolving: [
                { title: 'Agile Pivot', keyword: '데이터 검증', desc: '초기 주제(스타트업 평가)의 데이터 확보 불가능성을 빠르게 판단하고, 오픈 데이터 활용 전략으로 신속하게 선회하여 프로젝트 완주.' },
                { title: '분석 기술', keyword: 'BERTopic & NLP', desc: '딥러닝 기반 토픽 모델링과 감성 분석을 수행하여, 일반 식당은 "맛/친절"이, 파인다이닝은 "분위기/경험"이 핵심 키워드임을 도출.' },
                { title: '전략 도출', keyword: 'Segmentation', desc: '소비자 특성에 따라 4개의 군집으로 세분화하고, 각 타겟의 니즈(가성비 vs 가심비 등)에 맞춘 구체적인 마케팅 전략 수립.' }
            ],
        ...
        },
        {
            ...
            icon: '🏪',
            overview: { period: '2023.10 ~ 2023.11', team: '팀 프로젝트(2명)', role: 'Data Analyst (데이터 분석 총괄)' },
            ...
            problemSolving: [
                { title: '진단', keyword: 'Location Risk', desc: '상권 데이터 분석 결과, 타 밀집 지역 대비 유동인구가 현저히 적어 "오프라인 방문객 유치"만으로는 성장에 한계가 있음을 냉철하게 진단.' },
                { title: '발굴', keyword: 'Text Mining', desc: '3개 채널의 고객 리뷰를 분석하여, 특정 메뉴(프룬주스)에 대한 충성도와 "매일 마시고 싶다(정기 구독)"는 반복된 잠재 니즈를 텍스트 마이닝으로 포착.' },
                { title: '검증', keyword: 'Clustering & Learning', desc: '비전공자의 기술적 한계를 극복하기 위해 생성형 AI와 관련 강의로 군집 분석(Clustering)을 독학. 고객군을 정량적으로 분류하여 구독 서비스의 타당성을 입증.' }
            ],
            images: ['./images/subscription_1.jpg', './images/subscription_2.jpg', './images/subscription_3.jpg']
        },
        ...
        // --- [Strategy & Planning] ---
        {
            ...
            problemSolving: [
                { title: 'Pain Point', keyword: '디지털 경험의 단절', desc: '시장 분석 결과, 외국인 관광객은 한국 전화번호 인증 불가로 예약/결제에 실패하고, 구글맵 대신 불친절한 로컬 앱을 써야 하는 "이중고"를 겪고 있음을 규명.' },
                { title: '전략 수립', keyword: 'PPP Ecosystem', desc: '공공의 데이터 신뢰성과 민간의 기술/플랫폼을 결합하여, 하나의 앱에서 예약부터 MaaS까지 해결하는 협력 생태계 설계.' },
                { title: '솔루션', keyword: 'Barrier-Free UX', desc: '외국인 전용 간편 결제, 알러지/비건을 위한 바코드 성분 번역, AI 맞춤 코스 추천 등 실질적 편의 기능을 Figma로 구체화하여 구현.' }
            ],
        ...
        },
        {
            ...
            icon: '🛵',
            overview: { period: '2024.07 ~ 2024.08', team: '팀 프로젝트(2명)', role: 'Main PM, 전략 기획, 디자인(100%)' },
            ...
            problemSolving: [
                { title: '데이터 분석', keyword: 'Own Survey', desc: '자체 설문조사를 직접 설계/수행하여, 소비자들이 전기이륜차를 기피하는 핵심 원인이 성능이 아닌 "배달용 오토바이"라는 낙인 효과임을 규명.' },
                { title: '전략 수립', keyword: 'Re-branding', desc: '기존 오토바이의 문법을 버리고 "가볍고 스마트한 이동수단(Minimal Mobility)"으로 재정의. 타겟을 직장인(B2B/경제성)과 대학생(B2C/힙함)으로 이원화하여 공략.' },
                { title: '실행', keyword: 'Visual Making', desc: '기획한 전략의 설득력을 높이기 위해 Figma를 활용하여 BSS 앱 UI, 홍보 포스터, 팜플렛 등 마케팅 에셋(Asset) 전체를 직접 제작 및 시각화.' }
            ],
            images: ['./images/lg-ensol_1.jpg', './images/lg-ensol_2.jpg']
        },
        {
            id: 'fastcampus',
            type: 'strategy-planning', // 변경됨
            ...
            problemSolving: [
                { title: '문제 정의', keyword: 'Black Box Hiring', desc: '기존 재취업 시장은 이력서 위주의 단순 매칭으로, 스타트업이 요구하는 "실질적 문제 해결 능력"과 "조직 융화력"을 사전에 검증하기 어렵다는 구조적 한계 발견.' },
                { title: '솔루션', keyword: 'Virtual Biz Case', desc: 'AI가 지원자의 전문 분야에 맞춰 생성한 "가상 비즈니스 시나리오"를 수행하게 하고, 해결 과정을 분석하여 단순 경력이 아닌 "현재의 실무 역량"을 점수화하는 평가 모델 구축.' },
                { title: '기술 전략', keyword: 'Synthetic Data', desc: '서비스 초기 학습 데이터 부족(Cold Start) 문제를 해결하기 위해, 팔란티어 사례를 벤치마킹하여 "합성 데이터"로 다양한 비즈니스 케이스를 무한 생성하는 기술적 파이프라인 제안.' }
            ],
        ...
        },
        {
            ...
            icon: '🎓',
            overview: { period: '2024.03 ~ 2025.02', team: 'BACS', role: '부학회장' },
            ...
            problemSolving: [
                { title: '컨설팅 세션', keyword: 'Logical Thinking', desc: '이마트, 넷플릭스, 현대카드 등 실제 기업 사례를 리서치하여, 경영 전략 프레임워크에 맞춰 분석, 논리적인 전략 방향성을 도출.' },
                { title: '데이터 분석', keyword: 'Python & Stats', desc: 'Python을 활용해 고객 데이터를 시각화하고, T-test 등 통계적 검정 기법을 적용하여 데이터 기반의 의사결정 근거 마련.' },
                { title: 'ML & 딥러닝', keyword: 'Predictive Modeling', desc: 'HR 승진 예측(Random Forest, 정확도 93%) 및 신용카드 이탈률 분석프로젝트를 수행하고, CNN 등 딥러닝 모델을 학습하여 외부 공모전 활용.' },
                { title: '리더십', keyword: 'Operation & Planning', desc: '부학회장으로서 기존 이론 중심 커리큘럼의 한계를 보완하기 위해 "관심사별 팀 서브 세션"을 신규 기획 및 도입하여 학회원들의 자발적 프로젝트 참여를 유도.' }
            ],
        ...
        },
        {
            ...
            problemSolving: [
                { title: '시나리오 분석', keyword: 'Future Landscape', desc: 'CBDC "완전 도입" 시나리오를 설정하고, 금융 흐름의 투명성이 가져올 변화를 예측. 결제 데이터의 가시화가 보험업계의 난제인 "정보 비대칭"을 해결할 핵심 열쇠임을 도출.' },
                { title: '솔루션', keyword: 'Hyper-personalization', desc: '카카오페이 손해보험을 타겟으로, CBDC 결제 데이터와 마이데이터를 결합한 딥러닝 추천 알고리즘을 기획. 고객의 소비/지출 패턴을 분석해 최적의 보험 상품을 자동 매칭하는 시스템 설계.' },
                { title: '구체화', keyword: 'Figma UX', desc: '금융 앱(토스)을 벤치마킹하여, 어려운 보험 상품을 직관적으로 보여주는 UI/UX를 Figma로 프로토타이핑하여 제안서의 설득력을 시각적으로 강화.' }
            ],
        ...
        },
        {
            ...
            icon: '🌱',
            overview: { period: '2023.00 ~ 2023.00', team: '팀 프로젝트', role: '마케팅 전략 기획' }, // * 날짜 확인 필요
            keyResult: '♻️ 친환경 소재 소비 촉진을 위한 QR 기반 마케팅 솔루션 제안',
            catchphrase: '"착한 소비를 더 쉽고 직관적으로"',
            description_new: "소비자들이 친환경 제품인지 아닌지를 쉽게 확인하지 못한다는 문제에 집중했습니다. 소재 정보를 직관적으로 보여주는 QR 코드 디자인과, 참여형 캠페인 전략을 기획하여 지속 가능한 소비 문화를 제안했습니다.",
            problemSolving: [
                { title: '아이디어 기획', keyword: 'Gamification', desc: 'QR코드 확장 디자인 및 게이미피케이션 요소를 도입하여 소비자 참여 유도.' },
                { title: '협업 관리', keyword: 'Communication', desc: '익명 피드백 시스템과 회의 문서 공유 프로세스 도입으로 커뮤니케이션 효율성 증대.' }
            ],
            images: []
        },
        {
            ...
            icon: '🏫',
            overview: { period: '2023.10 ~ 2023.12', team: '팀 프로젝트(4명)', role: 'Idea Proposal' },
            ...
            problemSolving: [
                { title: '공감', keyword: 'Interview', desc: '실제 유학생 심층 인터뷰를 통해 학업적 어려움보다 정서적 고립감이 더 큰 문제임을 발견.' },
                { title: '벤치마킹', keyword: 'Peer Coaching', desc: '기존의 학습 중심 튜터링과 달리, 생활 적응과 네트워킹에 초점을 맞춘 "전담 또래 코칭" 모델 설계.' },
                { title: '기대효과', keyword: 'Social Value', desc: '유학생 중도 이탈률 감소 및 캠퍼스 다양성 증진이라는 사회적 가치(S) 창출 효과 제시.' }
            ],
            images: []
        }
    ]
